	...
	$(function () {
		...
		function attachFormValidator(elements) {
			...
			var regularConstraintsMessages = [
				{
					type: plugins.regula.Constraint.Required,
					newMessage: "The text field is required."
				},
				{
					type: plugins.regula.Constraint.Email,
					newMessage: "The email is not a valid email."
				},
				{
					type: plugins.regula.Constraint.Numeric,
					newMessage: "Only numbers are required"
				},
				{
					type: plugins.regula.Constraint.Selected,
		...
		if (isIE) {
			...
			if (isIE < 11) {
				$.getScript('js/pointer-events.min.js')
						.done(function () {
							$html.addClass("ie-10");
							plugins.PointerEventsPolyfill.initialize({});
						});
			}
